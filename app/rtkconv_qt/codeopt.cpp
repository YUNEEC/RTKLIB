...
void CodeOptDialog::showEvent(QShowEvent* event)
{
    ...
    C40->setChecked(mask[5][46]=='1');
    C41->setChecked(mask[5][47]=='1');
...
void CodeOptDialog::BtnOkClick()
{
    ...
    if (C40->isChecked()) mask[5][46]='1';
    if (C41->isChecked()) mask[5][47]='1';
...
void CodeOptDialog::UpdateEnable(void)
{
    ...
    E33->setEnabled((NavSys&SYS_GAL)&&(FreqType&FREQTYPE_E6));
    E34->setEnabled((NavSys&SYS_GAL)&&(FreqType&FREQTYPE_E6));
    ...
    J24->setEnabled((NavSys&SYS_QZS)&&(FreqType&FREQTYPE_L2));
    J25->setEnabled((NavSys&SYS_QZS)&&(FreqType&FREQTYPE_L2));
    J26->setEnabled((NavSys&SYS_QZS)&&(FreqType&FREQTYPE_L2));
    ...
    I52->setEnabled((NavSys&SYS_CMP)&&(FreqType&FREQTYPE_S));
    I53->setEnabled((NavSys&SYS_CMP)&&(FreqType&FREQTYPE_S));
    I54->setEnabled((NavSys&SYS_CMP)&&(FreqType&FREQTYPE_S));
    I55->setEnabled((NavSys&SYS_CMP)&&(FreqType&FREQTYPE_S));
